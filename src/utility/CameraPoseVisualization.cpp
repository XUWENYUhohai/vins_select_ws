...
void CameraPoseVisualization::add_edge(const Eigen::Vector3d& p0, const Eigen::Vector3d& p1){
    ...
    marker.type = visualization_msgs::Marker::LINE_LIST;//线列表LINE_LIST（不连续），https://blog.csdn.net/u013834525/article/details/80447931?spm=1001.2101.3001.6661.1&utm_medium=distribute.pc_relevant_t0.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-1-80447931-blog-70332256.pc_relevant_3mothn_strategy_recovery&depth_1-utm_source=distribute.pc_relevant_t0.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-1-80447931-blog-70332256.pc_relevant_3mothn_strategy_recovery
    marker.action = visualization_msgs::Marker::ADD;
    marker.scale.x = 0.005;//定义线宽。比例尺值以米为单位。

    marker.color.g = 1.0f;//g:绿色
    marker.color.a = 1.0;
...
void CameraPoseVisualization::add_loopedge(const Eigen::Vector3d& p0, const Eigen::Vector3d& p1){
    ...
    marker.ns = m_marker_ns;
    marker.id = m_markers.size() + 1;
    marker.type = visualization_msgs::Marker::LINE_LIST;//https://blog.csdn.net/REXLXX/article/details/102768121?spm=1001.2101.3001.6650.5&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-5-102768121-blog-70332256.pc_relevant_3mothn_strategy_recovery&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7ECTRLIST%7ERate-5-102768121-blog-70332256.pc_relevant_3mothn_strategy_recovery
    marker.action = visualization_msgs::Marker::ADD;//https://blog.csdn.net/learning_tortosie/article/details/103136707?spm=1001.2101.3001.6650.7&utm_medium=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7ERate-7-103136707-blog-70332256.pc_relevant_3mothn_strategy_recovery&depth_1-utm_source=distribute.pc_relevant.none-task-blog-2%7Edefault%7EBlogCommendFromBaidu%7ERate-7-103136707-blog-70332256.pc_relevant_3mothn_strategy_recovery
    marker.scale.x = 0.04;
    //marker.scale.x = 0.3;
...
void CameraPoseVisualization::add_pose(const Eigen::Vector3d& p, const Eigen::Quaterniond& q) {
    ...
    marker.ns = m_marker_ns;
    marker.id = m_markers.size() + 1;
    marker.type = visualization_msgs::Marker::LINE_STRIP;//线带LINE_STRIP(连续)
    marker.action = visualization_msgs::Marker::ADD;
    ...
    marker.colors.push_back(m_image_boundary_color);//应该一个是点的颜色一个是线条的颜色
...
void CameraPoseVisualization::publish_by( ros::Publisher &pub, const std_msgs::Header &header ) {
	visualization_msgs::MarkerArray markerArray_msg;//,这允许一次性发布很多marker
